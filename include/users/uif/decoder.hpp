...
class UIFDecoder final {
  private:
    ...
    static constexpr uint64_t DATA_SIZE{0x30};
    ...
    static constexpr uint64_t USERNAME_BLOCK_SIZE{0x10};
    static constexpr uint64_t PASSWORD_BLOCK_OFFSET{0x20};
    static constexpr uint64_t PASSWORD_BLOCK_SIZE{0x10};
